...
SQL Queries: check them out here at [project_sql folder](/project_sql/)
# Background
...
1. **SQL**: Backbone of the analysis, helped me query the database and unearth critical insights.
2. **PostgreSQL**: The chosen database management system, ideal for handling the job posting data.
3. **V.S Code**: My go-to for executing queries and database management.
...
All listed positions were remote (listed as "Anywhere").
All positions were full-time roles.

**Visualization**
![alt text](assets/graph.jpg)
*Generated by chatgpt based on the SQL Queries*
...
*Generated with the help of MS Excel based on top demanded skills and their count.*
...
1.**Top-Paying Data Analyst jobs :** The highest paying jobs for data analysts that allow remote-work offer a wide range of salaries, the highesr at $6,50,000.

2.**Skills for Top-Paying jobs :** High-paying data analyst jobs required advanced proficiency in SQL, suggesting that it is a critical skill for earning a top salary.

3.**Most in-demand skills :** SQL is also the most demanded skill in the data analyst job market, thus making it essential for job seekers. 

4.**Skills with higher salaries :** Specialized skills such as SVN, Kafka, Git, Oracle and Linux are some skills that are associated with higher salaries around $400,000 in Belarus.

5.**Optimal skills for job market value :** SQL leads in demand and offers for a high average salary, positioning it as one of the most optimal skills to learn as a data analyst to enhance their market value.
